...
export function Header() {
  ...
  return (
    <div className="flex items-center p-4 border-b-[1px] border-[#4CE0B388]">
      <div className="font-bold text-[#4CE0B3] text-2xl">
        <Link to="/">pastelbin</Link>
      </div>
      <div className="mx-2">pastebin except it's pastelite's</div>
